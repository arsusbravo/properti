...
<template>
    <Head :title="title">
        ...
        <!-- Open Graph -->
        <meta head-key="og:title" property="og:title" :content="title + ' - PropertiKu'" />
        ...
        <meta head-key="og:site_name" property="og:site_name" content="PropertiKu" />

        <!-- Twitter Card -->
        <meta head-key="twitter:card" name="twitter:card" :content="image ? 'summary_large_image' : 'summary'" />
        <meta head-key="twitter:title" name="twitter:title" :content="title + ' - PropertiKu'" />
